...
export function createStationCard(result) {
  ...
  `;
    card.addEventListener('click', (e) => {
        ...
        if (target.closest('.btn-route') || target.closest('.btn-fav') || target.closest('.btn-share'))
            return;
...
async function shareStation(name, price, lat, lng, fuelType) {
